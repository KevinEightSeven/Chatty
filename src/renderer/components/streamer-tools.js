// ── Default alert templates (mirrored from overlay-server.js) ──
function _defaultAlertHtml(icon, sublabel, typeName) {
  return `<div id="app">
  <div class="notif">
...
function _defaultAlertCss(accent) {
...
const DEFAULT_ALERT_TEMPLATES = {
  follow:    { html: _defaultAlertHtml('+1', 'new', 'follower'),      css: _defaultAlertCss('#e8bf49'), js: '' },
  subscribe: { html: _defaultAlertHtml('+1', 'new', 'subscriber'),    css: _defaultAlertCss('#9146ff'), js: '' },
  cheer:     { html: _defaultAlertHtml('{amount}', 'new', 'cheer'),   css: _defaultAlertCss('#00b4d8'), js: '' },
  raid:      { html: _defaultAlertHtml('{viewers}', 'new', 'raid'),   css: _defaultAlertCss('#ef4444'), js: '' },
};
