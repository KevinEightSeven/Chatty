  ...
  async showSettingsModal() {
    ...
    const html = `
      ...
      <div class="account-section">
        ...
        <div class="form-group" style="display:flex;align-items:center;gap:8px;margin-top:8px;">
          <input type="checkbox" id="setting-join-leave" ${showJoinLeave ? 'checked' : ''} style="width:auto;">
          <label for="setting-join-leave" style="margin:0;">Show Join/Leave Messages</label>
        </div>
        <p class="form-hint" style="margin-top:2px;">Show system messages when users join or leave the channel.</p>
      </div>
      <div class="account-section">
        <h3>Data Folder</h3>
    ...
    document.getElementById('btn-save-settings')?.addEventListener('click', async () => {
      ...
      const newShowJoinLeave = document.getElementById('setting-join-leave').checked;
      ...
      await window.chatty.setConfig('settings.showJoinLeave', newShowJoinLeave);
